...
*Nota*: estamos usando que $F_max = c(S T)$ con $S T$ un corte mínimo, nos alcanza con limitar el flujo de las aristas de $S T$ tal que sumen exactamente $F_max$ durante la construcción de la red residual.